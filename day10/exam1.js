...
/* [1] 객체 선언 :  */
// const person = { name : "유재석", age : 40, city : "안양시"};
...
// const book = { title: 'Cracking the Coding Interview', author: 'Gayle Laakmann McDowell', pages: 500 };
// let values = Object.values(book); /* [1] 객체내 값 반환 : Object.values(변수명); */
// for(let index = 0; index <= values.length-1; index++){  // [2] 0부터 마지막인덱스까지 배열 순회 (반복)
//     console.log(values[index]); // index번째 호출
// }
...
// const character = {  name: '전사', hp: 200, mp: 50 };
// console.log('leverl' in character);
...
// [1] 공공데이터로부터 신청한 자료 결과 복사 붙여넣기 : https://api.odcloud.kr/api/3044322/v1/uddi:89061f01-5fd0-43e3-9aa3-8513be01cad5?page=1&perPage=10&serviceKey=07d617b99e65f217218cb522b551064355e286c26cf9053a25cf94086d1504be
...
/* [2] 실질적인 데이터가 있는 속성 : date */
let data = response.data;
let html = '<table>';
// [3] data안에 있는 요소 들을 반복문으로 순회(0부터 마지막인덱스)하기

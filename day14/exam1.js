...
titleDom.innerHTML = 'DOM 조작 성공!';// 2. 특정한 마크업내 텍스트 .innerHTML, <마크업> 여기가 INNER </마크업>
...
for(let index = 0; index <= itemDom.length-1; index ++){
    ...
    // item.style = 'color : green; fontWeight : bold';
}
...
// <마크업 oncluck = "함수명()" /> : 클릭했을 때
// <마크업 onchange = "함수명() "/> : 값 변경 되었을 때
function func8(){
...
// 지역변수 대신에 전역변수 선언한 이유 : 등록할 떄 마다 함수는 재실행 / 초기화 / 영구 저장 안됨
